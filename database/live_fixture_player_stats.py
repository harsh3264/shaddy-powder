...
def load_fixture_player_stats(query):
    ...
    truncate_query = "TRUNCATE TABLE live_updates.live_fixture_player_stats"
    ...
    for fixture in fixtures:
        ...
        if not player_stats_data:
            ...
            insert_query = "INSERT INTO live_updates.live_fixture_player_stats (fixture_id) VALUES (%s)"
